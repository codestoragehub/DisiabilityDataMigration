...
namespace DisabilityInPortal.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220217093648_AddedContributionOfCapitalAndExpertise")]
    partial class AddedContributionOfCapitalAndExpertise
    {
            ...
            modelBuilder.Entity("DisabilityInPortal.Domain.Entities.SiteVisitReview", b =>
                {
                    ...
                    b.Property<bool>("FirmNotOwnedByPwd")
                        .HasColumnType("bit");

                    b.Property<bool>("HasCommonEmployeesUse")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsEquityOwnership")
                        .HasColumnType("bit");

                    b.Property<bool>("IsInterFirmTransactions")
                        .HasColumnType("bit");

                    b.Property<bool>("IsManagement")
                        .HasColumnType("bit");

                    b.Property<bool>("IsOfficeOrFacilitiesSharing")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("PwdCanNotDemonstrateInvestment")
                        .HasColumnType("bit");

                    b.Property<bool>("PwdCapitalContributionNotCommensurate")
                        .HasColumnType("bit");

                    b.Property<bool>("PwdExpertiseContributionNotCommensurate")
                        .HasColumnType("bit");

                    b.Property<bool>("PwdMaintainsJobElseWhere")
                        .HasColumnType("bit");

                    b.Property<bool>("PwdMaintainsNotOwnedFirm")
                        .HasColumnType("bit");

                    b.Property<bool>("PwdNotControlDailyOperations")
                        .HasColumnType("bit");

                    b.Property<bool>("PwdNotHaveTechnicalExpertise")
                        .HasColumnType("bit");

                    b.Property<bool>("PwdOperatesWithOtherIndividuals")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("SiteVisitInPerson")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("SiteVisitVirtual")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("ContributionOfCapitalAndExpertiseId");

                    b.HasIndex("UserId");

                    b.ToTable("SiteVisitReviewDetails", "dbo");
                });
            ...
            modelBuilder.Entity("DisabilityInPortal.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("DisabilityInPortal.Domain.Entities.Payment", "Payment")
                        .WithOne("Invoice")
                        .HasForeignKey("DisabilityInPortal.Domain.Entities.Invoice", "InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DisabilityInPortal.Domain.Entities.SiteVisitReview", b =>
                {
                    ...
                    b.HasOne("DisabilityInPortal.Domain.Entities.ContributionOfCapitalAndExpertise", "ContributionOfCapitalAndExpertise")
                        .WithMany()
                        .HasForeignKey("ContributionOfCapitalAndExpertiseId");
