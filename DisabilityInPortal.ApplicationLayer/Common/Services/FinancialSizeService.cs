...
{
    public class FinancialSizeService : IFinancialSizeService
    {
        ...
        private readonly IList<int> _skipFileUploadNonUSCertificationAgencies = new List<int> { 3, 7 };

        public FinancialSizeService(
        ...
        public async Task<bool> SkipDocumentUploadAsync(int applicationId)
        {
            ...
            if (isNonUSACompany)
                ...
                _skipFileUploadNonUSCertificationAgencies.Any(s => a.CertificationAgencyId == s));
